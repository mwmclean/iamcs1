...
## ".C"                     14.08    97.10      14.08     97.10
## "%*%"                     0.16     1.10       0.16      1.10
## "eigen"                   0.08     0.55       0.08      0.55
## "crossprod"               0.04     0.28       0.04      0.28
## "sort.int"                0.04     0.28       0.04      0.28
## "gam.fit"                 0.02     0.14      14.32     98.76
## "quantile.default"        0.02     0.14       0.06      0.41
## "na.omit.data.frame"      0.02     0.14       0.04      0.28
## "[.data.frame"            0.02     0.14       0.02      0.14
## "tcrossprod"              0.02     0.14       0.02      0.14
## 
## $by.total
##                       total.time total.pct self.time self.pct
## "block_exec"               14.50    100.00      0.00     0.00
## "call_block"               14.50    100.00      0.00     0.00
## "doTryCatch"               14.50    100.00      0.00     0.00
## "eval"                     14.50    100.00      0.00     0.00
## "evaluate"                 14.50    100.00      0.00     0.00
## "evaluate_call"            14.50    100.00      0.00     0.00
## "force"                    14.50    100.00      0.00     0.00
## "gam"                      14.50    100.00      0.00     0.00
## "handle"                   14.50    100.00      0.00     0.00
## "ifelse"                   14.50    100.00      0.00     0.00
## "in_dir"                   14.50    100.00      0.00     0.00
## "knit"                     14.50    100.00      0.00     0.00
## "parse_page"               14.50    100.00      0.00     0.00
## "process_file"             14.50    100.00      0.00     0.00
## "process_group"            14.50    100.00      0.00     0.00
## "process_group.block"      14.50    100.00      0.00     0.00
## "slidify"                  14.50    100.00      0.00     0.00
## "try"                      14.50    100.00      0.00     0.00
## "tryCatch"                 14.50    100.00      0.00     0.00
## "tryCatchList"             14.50    100.00      0.00     0.00
## "tryCatchOne"              14.50    100.00      0.00     0.00
## "withCallingHandlers"      14.50    100.00      0.00     0.00
## "withVisible"              14.50    100.00      0.00     0.00
## "estimate.gam"             14.40     99.31      0.00     0.00
## "gam.fit"                  14.32     98.76      0.02     0.14
## ".C"                       14.08     97.10     14.08    97.10
## "magic"                    14.08     97.10      0.00     0.00
## "magic.post.proc"           0.22      1.52      0.00     0.00
## "%*%"                       0.16      1.10      0.16     1.10
## "eigen"                     0.08      0.55      0.08     0.55
## "totalPenaltySpace"         0.08      0.55      0.00     0.00
## "quantile.default"          0.06      0.41      0.02     0.14
## "apply"                     0.06      0.41      0.00     0.00
## "FUN"                       0.06      0.41      0.00     0.00
## "matrix"                    0.06      0.41      0.00     0.00
## "variable.summary"          0.06      0.41      0.00     0.00
## "crossprod"                 0.04      0.28      0.04     0.28
## "sort.int"                  0.04      0.28      0.04     0.28
